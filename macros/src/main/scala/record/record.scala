...
package object record {
  ...
  private [record] type sf10 = SelectFields10[_,_, _, _, _, _, _, _, _, _, _]
  private [record] type sf11 = SelectFields11[_,_, _, _, _, _, _, _, _, _, _, _]
  private [record] type sf12 = SelectFields12[_,_, _, _, _, _, _, _, _, _, _, _, _]
