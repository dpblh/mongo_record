 ...
 */
case class Fields(f_double: Double, f_boolean: Boolean, f_int: Int, f_long: Long, f_string: String, f_float: Float,  f_byte: Byte,  f_byte_array: Array[Byte],  f_big_int: BigInt, f_bid_decimal: BigDecimal, f_date: java.util.Date, f_calendar: java.util.Calendar) {
...
class TestSimpleFields extends Spec {
  ...
  Fields(1.1, true, 1, 1l, "string", 1f, 1.toByte, Array(1.toByte), BigInt(1000), BigDecimal(100), new java.util.Date(), java.util.Calendar.getInstance()).save()
  Fields(1.1, true, 1, 1l, "string", 1f, 1.toByte, Array(1.toByte), BigInt(1000), BigDecimal(100), new java.util.Date(), java.util.Calendar.getInstance()).save()
  Fields(1.1, true, 1, 1l, "string", 1f, 1.toByte, Array(1.toByte), BigInt(1000), BigDecimal(100), new java.util.Date(), java.util.Calendar.getInstance()).save()
  Fields(1.1, true, 1, 1l, "string", 1f, 1.toByte, Array(1.toByte), BigInt(1000), BigDecimal(100), new java.util.Date(), java.util.Calendar.getInstance()).save()
